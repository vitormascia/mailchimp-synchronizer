...
function buildSyncContacts({ trioClient, mailchimpClient, }) {
    return async function syncContacts() {
        const trioContacts = await trioClient.getContacts();
        await mailchimpClient.batchAudienceMembers(MAILCHIMP.AUDIENCE_ID, {
...
//# sourceMappingURL=use-cases.contacts.syncContacts.js.map